...
export default function Menu() {
  ...
  return (
    <>
      {!isMobile && (
        <div className="flex h-full w-full flex-col gap-3 pb-8 lg:w-2/3 lg:items-center lg:justify-center lg:rounded-3xl lg:bg-blue lg:px-24 lg:py-8 lg:shadow-2xl lg:shadow-black/40">
          <Link
            href="/home/reserva"
