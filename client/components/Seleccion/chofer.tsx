...
export default function ProfileChofer() {
  return (
    <>
      ...
      <div className="w-1/2 flex items-center">
        <form className="mx-auto py-12 px-24 flex flex-col shadow-gray-500 shadow-xl w-4/5 gap-5 justify-center items-center">
          ...
          <div className="flex items-center flex-col gap-1">
            <label className="text-center">Tipo de vehiculo</label>
            <input className="pl-2 w-10/12 text-center" type="text" />
          </div>

          <div className="flex items-center flex-col gap-1">
            <label className="text-center">Patente de vehiculo</label>
            <input className="pl-2 w-10/12 text-center" type="text" />
          </div>

          <div className="flex items-center flex-col gap-1">
            <label className="text-center">Numero de cedula nacional de id</label>
            <input className="pl-2 w-10/12 text-center" type="text" />
          </div>
