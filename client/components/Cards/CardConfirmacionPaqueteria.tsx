...
export default function CardConfirmacionPaqueteria() {
  return (
    <div className="flex flex-col items-center justify-center gap-4 rounded-3xl border-2 py-20 shadow-2xl shadow-black/40 lg:px-2 lg:py-10">
      ...
      <Link
        href="/home/paqueteria/transportes/confirmacion/pagos"
