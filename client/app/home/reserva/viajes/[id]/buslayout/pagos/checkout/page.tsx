...
export default function Checkout() {
  ...
  useEffect(() => {
    if (window) {
      ...
      const paymentIdData = queryParams.get("payment_id" || null);
      const merchantOrderData = queryParams.get("merchant_order_id" || null);
      const statusData = queryParams.get("status" || null);
  ...
  useEffect(() => {
    const getToken = async () => {
      try {
        ...
        console.log("error en el axios de get payment merchant order");
        return error;
      }
    };
