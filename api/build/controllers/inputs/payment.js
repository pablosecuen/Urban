...
const getMerchantOrderData = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { merchantOrder } = req.query;
    try {
        const { data } = yield axios_1.default.get(`https://api.mercadopago.com/merchant_orders/${merchantOrder}`, {
            headers: {
